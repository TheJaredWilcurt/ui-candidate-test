...
// ///////////////////////////////////////////////////////////
// Write a function that takes a single argument (a string) //
...
// distinct values only (i.e. removes duplicates)       //
// ///////////////////////////////////////////////////////
...
// You have a second array of fruit name strings, that is a list of fruits  //
// that should be removed from the fruits specified in the master array.    //
// For the purpose of the exercise, we will call the master array fruits    //
// and the second array fruitsToRemove. Write the function that will remove //
// the values contained in fruitsToRemove from the array fruits.            //
// ///////////////////////////////////////////////////////////////////////////
...
// ///////////////////////////////////////////////////////////////////////////
// Write a function to push either a value or an array of values onto a     //
// specified array. For the purpose of the exercise, we will call the       //
// target array "array" and the stuff to push onto it (either a value or    //
// array) "toPush". If "toPush" is a value, it should be pushed onto        //
// "array" as an element. If "toPush" is an array, all of its elements      //
// should be pushed onto "array". Your solution should modify "array" (ie.  //
...
// ///////////////////////////////////////////////////////////////////////////
// Write a function that will return true if a specified string consists of //
// only whitespace.                                                         //
// ///////////////////////////////////////////////////////////////////////////
...
// //////////////////////////////////////////////////////////////////////
// Within div1, programatically create a SELECT element (with multiple //
// items) and a button. When the button is clicked write out the name  //
// and value of the selected item to the console.                      //
// //////////////////////////////////////////////////////////////////////
...
// /////////////////////////////////////////////////
// Write 5 different jQuery selectors to retrieve //
// the sample anchor from below.                  //
// /////////////////////////////////////////////////
...
// ////////////////////////////////////////////////
// Programatically create an array with 5 items. //
// Create a list item for each item in the array //
// and add the list items to the unordered list  //
// with an id of "list1".                        //
// ////////////////////////////////////////////////
...
// to the div with an id of "foobar". When the first link //
// is clicked, all the checkboxes should be checked (i.e. //
// check all). When the second link is clicked, all the   //
// checkboxes should be unchecked (i.e. uncheck all).     //
// /////////////////////////////////////////////////////////
